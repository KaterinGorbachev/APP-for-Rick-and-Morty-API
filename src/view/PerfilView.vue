<template>
  <main class="min-h-screen bg-[#7fdfd7] w-full flex flex-col p-[2rem] gap-[1rem]">
   ...
   hover:border-lime-300
    ...
    <h1 class="text-4xl md:text-5xl font-extrabold text-[#004240] drop-shadow-[0_0_25px_rgba(163,230,53,0.5)] ">¡Bienvinido de nuevo!</h1>
    ...
    <h2 class="text-3xl font-semibold text-[#003d3c] ">Collección</h2>
    ...
    <p class="text-xl font-semibold text-cyan-300" v-if="!favorites.length">
